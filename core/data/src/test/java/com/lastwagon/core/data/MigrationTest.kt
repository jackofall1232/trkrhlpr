 ...
 * the resulting schema against the exported v3 JSON. Complements the pure encode/decode tests
 * in [InspectionContentSchemaTest].
 */
...
class MigrationTest {
    ...
    @Test
    fun migratesFromV1ToV4PreservingRowsAndDefaults() {
