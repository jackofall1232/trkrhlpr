...
| CVSA North American Standard Out-of-Service Criteria | Proprietary, paid, restricted PDF (~$50, updated annually) | Excluded as a text source. Public defect criteria come from Appendix A to 49 CFR Part 396 instead. CVSA International Roadcheck press materials (public) may inspire topics only. |
